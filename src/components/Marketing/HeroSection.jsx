...
const HeroSection = () => {
  ...
  const handleLearnMore = () => {
    ...
    // If we're on another route, navigate to home with state
    navigate("/", { state: { scrollTo: "how-we-work" } });
  };
  ...
  return (
    <section className="relative flex flex-col items-center justify-center min-h-[90vh] sm:min-h-[92vh] text-center bg-black text-white px-4 sm:px-6 overflow-hidden">
      ...
      >
        <h1 className="font-extrabold tracking-tight text-[13vw] sm:text-[5.5rem] md:text-[6rem] lg:text-[6.5rem] leading-[1.05] sm:leading-[1]">
